          ...
          <div style={{display: 'flex', gap: '18px', alignItems: 'center'}}>
            ...
            {!mostrarAdmin && (
              <div 
                ...
                style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '4px 15px', backgroundColor: '#0a0a0a', borderRadius: '10px', border: `2px solid ${usbConectado ? 'rgba(0, 255, 255, 0.4)' : '#374151'}`, cursor: 'pointer', boxShadow: usbConectado ? 'inset 0 0 15px rgba(0,255,255,0.1)' : 'none', minWidth: '150px', justifyContent: 'space-between' }} 
