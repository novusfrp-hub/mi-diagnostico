...
export default function AppDiagnostico() {
  ...
  const editarPaso = (paso) => {
    setFormId(paso.id); setFormPregunta(paso.pregunta || ''); setFormEsFinal(!!paso.esFinal);
